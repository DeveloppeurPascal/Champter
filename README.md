...
The game's operation is inspired by [Fox](http://jeuxvideos8090.free.fr/index.php?Id_Soft=132), a video game from 1985, but the game levels come from [Copter](https://github.com/DeveloppeurPascal/Game-Copter-MSDOS-TurboPascal), which I developed in Turbo Pascal in 1992.
...
Visit [the Champter website](https://champter.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/Champter).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/Champter) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://champter.gamolf.fr) or [the project devlog](https://developpeur-pascal.fr/champter.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Champter/issues) so that I can test and try to correct or provide a workaround.
