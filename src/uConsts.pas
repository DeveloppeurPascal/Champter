(* C2PP
  ...
  ***************************************************************************
  File last update : 2025-05-25T19:09:44.000+02:00
  Signature : 025272d3708a03b6322211e9eb278c27a50bc32b
  ***************************************************************************
*)
...
const
  ...
  /// </summary>
  CAboutGameURL = 'https://champter.gamolf.fr/';
...
{$ENDIF}
  ...
  /// (without deployment)
  /// </summary>
  CDefaultBackgroundMusicPath = '..\..\..\_PRIVATE\GameDevMarket_com-HumbleBundle-20220901\Children_Game_Music\';
  ...
  /// </remarks>
  CBackgroundMusicFileName = 'Song_Exploration_02_Loop.wav';
  ...
  /// (without deployment)
  /// </summary>
  CDefaultSoundEffectsPath = '..\..\..\_PRIVATE\EpicStockMedia_com\MobileGame16Bits\';
  ...
  /// </summary>
  CGameGUID = '81A8A4C3-2199-4E03-998C-A72E89916F06';
